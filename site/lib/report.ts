 ...
 * through the same check every page on this site goes through. Parsed once, at build time.
 */
...
if (!checked.ok) throw new Error(`the demo fixture is not publishable: ${checked.error}`);
